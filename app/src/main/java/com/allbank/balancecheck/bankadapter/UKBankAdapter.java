...
public class UKBankAdapter extends RecyclerView.Adapter<UKBankAdapter.ViewHolder> {

    Context context;
    ArrayList<BankModel> UKBanks;

    public UKBankAdapter(Context context, ArrayList<BankModel> UKBanks){
        this.context = context;
        this.UKBanks = UKBanks;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.imageView.setImageResource(UKBanks.get(position).img);
        holder.bank_name.setText(UKBanks.get(position).bankname);
    }
