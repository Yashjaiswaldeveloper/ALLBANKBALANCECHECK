...
public class AustralianBankAdapter extends RecyclerView.Adapter<AustralianBankAdapter.ViewHolder> {

    Context context;
    ArrayList<BankModel> AustralianBanks;

    public AustralianBankAdapter(Context context, ArrayList<BankModel> AustralianBanks){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.imageView.setImageResource(AustralianBanks.get(position).img);
        holder.bank_name.setText(AustralianBanks.get(position).bankname);
    }

    @Override
    public int getItemCount() {
        return AustralianBanks.size();
    }
