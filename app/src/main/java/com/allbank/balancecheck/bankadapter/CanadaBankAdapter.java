...
public class CanadaBankAdapter extends RecyclerView.Adapter<CanadaBankAdapter.ViewHolder> {

    Context context;
    ArrayList<BankModel> CanadaBanks;

    public CanadaBankAdapter(Context context, ArrayList<BankModel> CanadaBanks){
        this.context = context;
        this.CanadaBanks = CanadaBanks;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.imageView.setImageResource(CanadaBanks.get(position).img);
        holder.bank_name.setText(CanadaBanks.get(position).bankname);
    }

    @Override
    public int getItemCount() {
        return CanadaBanks.size();
    }
