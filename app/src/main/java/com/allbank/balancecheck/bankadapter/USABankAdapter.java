...
public class USABankAdapter extends RecyclerView.Adapter<USABankAdapter.ViewHolder> {

    Context context;
    ArrayList<BankModel> USABanks;

    public USABankAdapter(Context context, ArrayList<BankModel> USABanks){
        this.context = context;
        this.USABanks = USABanks;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.imageView.setImageResource(USABanks.get(position).img);
        holder.bank_name.setText(USABanks.get(position).bankname);
    }

    @Override
    public int getItemCount() {
        return USABanks.size();
    }
